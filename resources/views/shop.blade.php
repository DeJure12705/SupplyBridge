              ...
              <ul class="list list-inline mb-0 brand-list">
                ...
                <li class="list-item">
                  <span class="menu-link py-1">
                    ...
                    @if (in_array($brand->id,explode(',',$f_brands))) @endif
                    {{$brand->name}}
                  </span>
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <div class="price-range__info d-flex align-items-center mt-2">
                <div class="me-auto">
                  ...
                  <span class="price-range__min">$100</span>
                </div>
                <div>
            ...
            <div class="swiper-slide">
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                ...
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #a0c9e3;">
        ...
        <div class="product-card-wrapper">
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              ...
              <a href="{{route('cart.index')}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning md-3">Go to Cart</a>
              @else
